...
class AVLTree
{
    ...
    private Node RightRotate(Node OriginalRoot)
    {
        ...
        // The left child of the node becomes the new root of the subtree.
        Node NewRoot = OriginalRoot.Left;

        //Save the Original Rigth Child Temperorly
        Node OriginalRightChild = NewRoot.Right;
    ...
    private Node LeftRotate(Node OriginalRoot)
    {
        ...
        Node NewRoot = OriginalRoot.Right;
        //Save the Original Left Child Temperorly
        Node OriginalLeftChild = NewRoot.Left;
    ...
    private bool Exists(Node node, string value)
    {
        if (node == null)
        {
    ...
    private void AutoComplete(Node node, string prefix, List<string> results)
    {
        if (node != null)
        {
...
class Program
{
    static void Main(string[] args)
    {
        ...
        string[] words = { "Ahmad", "Mohammed", "Motasem", "Mahmood", "Rezk", "John", "Alex", "Mohab", "Abla",
                            "Abeer", "Abdullah", "Abbas", "Montaser", "Khalil","Khalid" };
